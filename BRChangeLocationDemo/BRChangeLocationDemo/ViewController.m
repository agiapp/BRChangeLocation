...
- (void)locationManager:(CLLocationManager *)manager didUpdateLocations:(NSArray<CLLocation *> *)locations {
    ...
    // 当前的经纬度
    NSLog(@"当前的经纬度（WGS坐标系值）： %f, %f", currentLocation.coordinate.latitude, currentLocation.coordinate.longitude);
    CLLocationCoordinate2D location2D = CLLocationCoordinate2DMake(currentLocation.coordinate.latitude, currentLocation.coordinate.longitude);
    CLLocationCoordinate2D WGSlocation2D = [BRChangeLocation wgs84ToGcj02:location2D];
    NSLog(@"当前的经纬度（高德坐标系值）： %f, %f", currentLocation.coordinate.latitude, currentLocation.coordinate.longitude);
